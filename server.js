...
// *We are not using mirageJs - this is a backup for Firebase:
// to use mirage js:
// -add import './server' to indexedDB.jsx
// -delete  this.passthrough("https://firestore.googleapis.com/**") from this file
...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "456", email: "a@a.com", password: "p456", name: "Anna" })
        server.create("user", { id: "789", email: "c@c.com", password: "p789", name: "Carl" })
    },
